...
The main functions in `dplyr` pakage - Mutate - Select - Filter -
Arrange
...
Renaming columns … *Same for using either code below for renaming*
...
\*\* `==` is a test for equality, not adding the value into the column
(not as `=`)
